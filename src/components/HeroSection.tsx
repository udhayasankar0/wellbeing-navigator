    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="space-x-4 mb-16 animate-fade-in">
          <button className="bg-primary text-white px-8 py-3 rounded-lg hover:bg-primary/90 transition-colors duration-300 hover:scale-105 transform">
            Get Started Free
          </button>
          <button className="bg-white text-primary px-8 py-3 rounded-lg border-2 border-primary hover:bg-accent transition-colors duration-300 hover:scale-105 transform">
            Watch Demo
          </button>
        </div>
        <button
